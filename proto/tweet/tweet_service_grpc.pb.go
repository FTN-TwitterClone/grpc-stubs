...
type TweetServiceClient interface {
	UpdateFeed(ctx context.Context, in *Request, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *tweetServiceClient) UpdateFeed(ctx context.Context, in *Request, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type TweetServiceServer interface {
	UpdateFeed(context.Context, *Request) (*empty.Empty, error)
...
func (UnimplementedTweetServiceServer) UpdateFeed(context.Context, *Request) (*empty.Empty, error) {
