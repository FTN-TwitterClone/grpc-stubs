...
type AdsServiceClient interface {
	SaveAdInfo(ctx context.Context, in *AdInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SaveLikeEvent(ctx context.Context, in *LikeEvent, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SaveUnlikeEvent(ctx context.Context, in *UnlikeEvent, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *adsServiceClient) SaveAdInfo(ctx context.Context, in *AdInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *adsServiceClient) SaveLikeEvent(ctx context.Context, in *LikeEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *adsServiceClient) SaveUnlikeEvent(ctx context.Context, in *UnlikeEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type AdsServiceServer interface {
	SaveAdInfo(context.Context, *AdInfo) (*emptypb.Empty, error)
	SaveLikeEvent(context.Context, *LikeEvent) (*emptypb.Empty, error)
	SaveUnlikeEvent(context.Context, *UnlikeEvent) (*emptypb.Empty, error)
...
func (UnimplementedAdsServiceServer) SaveAdInfo(context.Context, *AdInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveAdInfo not implemented")
}
func (UnimplementedAdsServiceServer) SaveLikeEvent(context.Context, *LikeEvent) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveLikeEvent not implemented")
}
func (UnimplementedAdsServiceServer) SaveUnlikeEvent(context.Context, *UnlikeEvent) (*emptypb.Empty, error) {
