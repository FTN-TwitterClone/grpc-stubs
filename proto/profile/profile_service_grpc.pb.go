...
type ProfileServiceClient interface {
	RegisterUser(ctx context.Context, in *ProfileUser, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RegisterBusinessUser(ctx context.Context, in *ProfileBusinessUser, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *profileServiceClient) RegisterUser(ctx context.Context, in *ProfileUser, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *profileServiceClient) RegisterBusinessUser(ctx context.Context, in *ProfileBusinessUser, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type ProfileServiceServer interface {
	RegisterUser(context.Context, *ProfileUser) (*emptypb.Empty, error)
	RegisterBusinessUser(context.Context, *ProfileBusinessUser) (*emptypb.Empty, error)
...
func (UnimplementedProfileServiceServer) RegisterUser(context.Context, *ProfileUser) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUser not implemented")
}
func (UnimplementedProfileServiceServer) RegisterBusinessUser(context.Context, *ProfileBusinessUser) (*emptypb.Empty, error) {
